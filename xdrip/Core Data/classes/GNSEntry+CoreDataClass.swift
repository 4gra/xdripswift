...
public class GNSEntry: NSManagedObject {
    ...
    init(address: String, name: String, alias: String?, nsManagedObjectContext:NSManagedObjectContext) {
        ...
        blePeripheral = BLEPeripheral(address: address, name: name, alias: nil, cBCentralManagerRestoreIdentifierKey: "GNSEntry", nsManagedObjectContext: nsManagedObjectContext)
