...
public class Droplet: NSManagedObject {
    ...
    init(address: String, name: String, alias: String?, nsManagedObjectContext:NSManagedObjectContext) {
        ...
        blePeripheral = BLEPeripheral(address: address, name: name, alias: nil, cBCentralManagerRestoreIdentifierKey: "Droplet", nsManagedObjectContext: nsManagedObjectContext)
