...
public class MiaoMiao: NSManagedObject {
  ...
  /// create MiaoMiao
    ...
    init(address: String, name: String, alias: String?, nsManagedObjectContext:NSManagedObjectContext) {
        ...
        blePeripheral = BLEPeripheral(address: address, name: name, alias: nil, cBCentralManagerRestoreIdentifierKey: "MiaoMiao", nsManagedObjectContext: nsManagedObjectContext)
